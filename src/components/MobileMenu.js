                        ...
                        <div className="offcanvas-inner-content">
                            ...
                            <nav className="offcanvas-navigation" id="offcanvas-navigation">
                                <ul>
                                    ...
                                    <li >
                                        <Link to={`${process.env.PUBLIC_URL}/refinery`} >REFINING</Link>
                                ...
                                <div className="off-canvas-contact-widget">
                                    <div className="header-contact-info">
                                        <ul className="header-contact-info__list">
                                            <li><i className="ion-android-phone-portrait" /> <a href="tel://12452456012">(+254) 788 283 594 </a></li>
                                            <li><i className="ion-android-mail" /> <a href="mailto:info@yourdomain.com">info@aussie-mint.com</a></li>
                                        </ul>
                                    </div>
                                </div>
